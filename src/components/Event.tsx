...
type eventProps = {
    ...
    setPrintTarget: React.Dispatch<React.SetStateAction<string|null>>,
        ...
        <div className={"grid lg:grid-cols-2"}>
            <div className={"m-8"}>
                ...
                {props.competition.events[props.eventIndex].table.length > 0 ?
                    <div className={props.printTarget === "table" ? " print-visible" : " print:hidden"}>
                        ...
                        {!props.client && <div className={"flex"}>
                            <button onClick={() => props.print("table")}
